...
public class ImportStatistic_Form extends javax.swing.JPanel {
    ...
    private void cmdExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdExcelActionPerformed
        ...
        try {
            ...
            Sheet sheet = workbook.createSheet("Danh sách Phiếu Nhập Kho"); // Tạo sheet
            ...
            // Lưu file Excel
            String filePath = "src/ExportFile_Excel/DanhsachPNK_" + simpleDateFormat.format(new Date()) + ".xlsx";
